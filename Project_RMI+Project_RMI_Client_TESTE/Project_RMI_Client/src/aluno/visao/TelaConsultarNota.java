...
public class TelaConsultarNota extends JFrame {
	...
	public TelaConsultarNota(GestorAlunos gestor) {
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try {
						...
						if(a == null) {
							lblStatus.setText("Matricula Não Encontrada!");
							textField_1.setText("");
							textField_2.setText("");
							textField_3.setText("");
																																
						}else {
							lblStatus.setText("Matricula Encontrada!");													
						}					
